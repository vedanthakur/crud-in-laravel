...
Route::post('students/{student}/edit', [StudentController::class, 'edit'])->name('edit_student');
...
Route::post('profiles/{profile}/edit', [ProfileController::class, 'edit'])->name('edit_profile');
